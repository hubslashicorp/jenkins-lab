            ...
            steps {
                dir('app') {
                    ...
                    retry(2) {
                        script {
                            try {
                                sh 'chmod 777 -R script-directory && cd script-directory && ls -lha && bash ./script-one.sh'
            ...
            steps {
                dir('app') {
                    ...
                    retry(2) {
                        script {
                            try {
                                sh 'chmod 777 -R script-directory && cd script-directory && ls -lha && bash ./script-three.sh'
                                echo 'Script executado com sucesso...'
                            } catch (err) {
                                echo 'Não foi possível realizar a copia...'
                                echo err.getMessage()
